            ...
            <Card>
              <Flex direction="column" gap="4" p="4">
                ...
                <Flex direction="column" gap="2">
                  ...
                  <Text size="1" color="gray">
                    When all eligible media matching the instance's active filters has been searched, Scoutarr automatically removes its tag from those items, then immediately re-runs the search, keeping the cycle going indefinitely.
                  </Text>
                  <Text size="1" color="gray">
